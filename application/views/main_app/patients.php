...
<div class="page-head">
    ...
    <span class="sub-title">View/Add/Edit Patient</span>
    <div class="state-information">
        <div class="state-graph">
            <div class="info" id="patients_dash">Patients: 0</div>
        </div>        
    </div>
</div>
<!-- page head end-->
...
<!--                <header class="panel-heading">
                ...
                <div class="panel-body">
                    <!--User Datagrid.-->
                    <table class="easyui-datagrid" id="patients_dg" style="width:100%;height:350px" pagination="true" toolbar="#users_toolbar" data-options="url:'<?php echo site_url('Main_controller/get_patients') ?>',fitColumns:true,singleSelect:true,striped:true,rownumbers:true">
                        <thead>
                            <tr>
                                <th data-options="field:'patient_id',width:1,hidden:true">id</th>
                                <th data-options="field:'name',width:20">Full Name</th>
                                <th data-options="field:'birth_date',width:20">Birth Date</th>
                                <th data-options="field:'address',width:20">Address </th>
                                <th data-options="field:'phone',width:20">Contact</th>
                                <th data-options="field:'gender',width:20,formatter:sex_formatter">Sex</th>
                            </tr>
                        </thead>
                    </table>
                    <!-- User datagrid toolbar-->
                    <div id="users_toolbar">
                        <button id="add_patient"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">Add Patient</a></button>
                        <button id="edit_patient"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">Edit Patient</a></button>
                        <button id="delete_patient"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">Delete Patient</a></button>
                        
                        <span style="float: right;"><input type="search" class="easyui-searchbox" placeholder="Search Patient"  style="left: 50px;" id="search_patient" name="search_patient"/></span>
                    </div>
                    <!-- End of view users datagrid-->

                    <div class="easyui-dialog" id="patient_dlg" data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true" style="width: 700px; height: auto;top: 40px;" buttons="#patient_info_toolbar">
                        <form method="POST" name="patient_form" id="patient_form" enctype="multipart/form-data" action="<?php echo site_url('Main_controller/save_patient') ?>">
                            <div class="row" style="margin-top: 20px; width: 690px;" >
                                ...
                                <div class="col-sm-7" style="margin-left: 40px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="birth_date" id="birth_date" width="200px" class="easyui-datebox" data-options="required:true,formatter:myformatter,parser:myparser">
                                        </div>
                                    </div>                                    
                                    <br>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="easyui-filebox" width="200px" name="upload_picture" accept="image/*" id="upload_picture">
                                        </div>
                                    </div>
                                    <br>
                                </div>
                        ...
                        <div id="patient_info_toolbar">
                            <button id="save_patient"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true">Save</a></button>
                            <button id="cancel_patient_dlg"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true">Cancel</a></button>
                        </div>
                    </div>
...
<!--Easyui Scripts-->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/mine/js/patients.js"></script>
