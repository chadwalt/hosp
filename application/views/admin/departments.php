...
<div class="page-head">
    ...
    <span class="sub-title">View/Add/Edit Department</span>
    <div class="state-information">
        <div class="state-graph">
            <div class="info" id="departments_num">Departments: 0</div>
        </div>        
    </div>
</div>
<!-- page head end-->
        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <!--Department Datagrid.-->
                    <table  id="departments_dg" style="width:100%;height:350px" pagination="true" toolbar="#departments_toolbar" data-options="url:'<?php echo site_url('Admin/get_departments') ?>',fitColumns:true,singleSelect:true,striped:true,rownumbers:true">
                        <thead>
                            <tr>
                                <th field="department_id" width="100" hidden="true"> ID</th>
                                <th field="name" width="100" editor="text">Department Name</th>
                                <th field="description" width="150" editor="text">Description</th>                             
                            </tr>
                        </thead>
                    </table>
                    <!-- Department datagrid toolbar-->
                    <div id="departments_toolbar">
                        <button  onclick="javascript: $('#departments_dg').edatagrid('addRow'); " ><a href="javascript:undefined;"  class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">Add Department</a></button>
                        <button onclick="javascript: $('#departments_dg').edatagrid('saveRow'); refresh('#departments_dg');"><a href="javascript:undefined;"   class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">Save Department</a></button>
                        <button id="delete_department"><a href="javascript:undefined;" class="easyui-linkbutton"  data-options="iconCls:'icon-remove',plain:true">Delete Department</a></button>

                        <!--<button id="users_positions"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-redo',plain:true">Positions</a></button>-->
                        <button onclick="javascript: $('#departments_dg').edatagrid('cancelRow');"><a href="javascript:undefined;"  class="easyui-linkbutton" data-options="iconCls:'icon-undo',plain:true">Cancel</a></button>

                        <span style="float: right;"><input type="search" class="easyui-searchbox" placeholder="Search Department"  style="left: 50px;" id="search_student" name="search_department"/></span>
                    </div>
                    <!-- End of view Departments datagrid-->
