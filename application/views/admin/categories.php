...
<div class="page-head">
    ...
    <span class="sub-title">View/Add/Edit Categories</span>
    <div class="state-information">
        <div class="state-graph">
            <div class="info" id="categories_num">Categories: 0</div>
        </div>        
    </div>
</div>
<!-- page head end-->
        ...
        <div class="col-md-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <!--Category Datagrid.-->
                    <table  id="categories_dg" style="width:100%;height:350px" pagination="true" toolbar="#categories_toolbar" data-options="url:'<?php echo site_url('Admin/get_med_categories') ?>',fitColumns:true,singleSelect:true,striped:true,rownumbers:true">
                        <thead>
                            <tr>
                                <th field="id" width="100" hidden="true"> ID</th>
                                <th field="name" width="100" editor="text">Category Name</th>
                                <th field="description" width="150" editor="text">Description</th>                             
                            </tr>
                        </thead>
                    </table>
                    <!-- Category datagrid toolbar-->
                    <div id="categories_toolbar">
                        <button  onclick="javascript: $('#categories_dg').edatagrid('addRow'); " ><a href="javascript:undefined;"  class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">Add Category</a></button>
                        <button onclick="javascript: $('#categories_dg').edatagrid('saveRow'); refresh('#categories_dg');"><a href="javascript:undefined;"   class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true">Save Category</a></button>
                        <button id="delete_category"><a href="javascript:undefined;" class="easyui-linkbutton"  data-options="iconCls:'icon-remove',plain:true">Delete Category</a></button>

                        <!--<button id="users_positions"><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-redo',plain:true">Positions</a></button>-->
                        <button onclick="javascript: $('#categories_dg').edatagrid('cancelRow');"><a href="javascript:undefined;"  class="easyui-linkbutton" data-options="iconCls:'icon-undo',plain:true">Cancel</a></button>

                        <span style="float: right;"><input type="search" class="easyui-searchbox" placeholder="Search Category"  style="left: 50px;" id="search_student" name="search_category"/></span>
                    </div>
                    <!-- End of view Categorys datagrid-->
...
<!--Mine Scripts-->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/mine/js/categories.js"></script>
