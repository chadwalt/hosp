...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/bower_components/bootstrap/dist/css/bootstrap.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/bower_components/animate.css/animate.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/bower_components/font-awesome/css/font-awesome.min.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/bower_components/simple-line-icons/css/simple-line-icons.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/html/css/font.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo base_url(''); ?>libraries/html/css/app.css" type="text/css" />
    ...
    <body>
        ...
        <script src="<?php echo base_url(''); ?>libraries/bower_components/jquery/dist/jquery.min.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/bower_components/bootstrap/dist/js/bootstrap.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/html/js/ui-load.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/html/js/ui-jp.config.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/html/js/ui-jp.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/html/js/ui-nav.js"></script>
        <script src="<?php echo base_url(''); ?>libraries/html/js/ui-toggle.js"></script>
    </body>
</html>
